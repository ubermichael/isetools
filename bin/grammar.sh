...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta property="fb:app_id" content="1401488693436528">
      ...
      <meta content="@github" name="twitter:site" /><meta content="summary" name="twitter:card" /><meta content="emmental/isetools" name="twitter:title" /><meta content="isetools - Tools for parsing data for the Internet Shakespeare Editions " name="twitter:description" /><meta content="https://avatars0.githubusercontent.com/u/1436428?v=3&amp;s=400" name="twitter:image:src" />
      <meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/1436428?v=3&amp;s=400" property="og:image" /><meta content="emmental/isetools" property="og:title" /><meta content="https://github.com/emmental/isetools" property="og:url" /><meta content="isetools - Tools for parsing data for the Internet Shakespeare Editions " property="og:description" />
...
<meta content="vAiKkvxWQyxRNgyWCLB5kooIvOLTlrAoHfwTAyydBWo12DIkrgWJ0FjcOvLMC18leRoG5kOx4g3IX5SGRqakaQ==" name="csrf-token" />
  ...
  <meta name="description" content="isetools - Tools for parsing data for the Internet Shakespeare Editions ">
  <meta name="go-import" content="github.com/emmental/isetools git https://github.com/emmental/isetools.git">

  <meta content="1436428" name="octolytics-dimension-user_id" /><meta content="emmental" name="octolytics-dimension-user_login" /><meta content="32296059" name="octolytics-dimension-repository_id" /><meta content="emmental/isetools" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="true" name="octolytics-dimension-repository_is_fork" /><meta content="30341870" name="octolytics-dimension-repository_parent_id" /><meta content="ubermichael/isetools" name="octolytics-dimension-repository_parent_nwo" /><meta content="30341870" name="octolytics-dimension-repository_network_root_id" /><meta content="ubermichael/isetools" name="octolytics-dimension-repository_network_root_nwo" />
  <link href="https://github.com/emmental/isetools/commits/master.atom" rel="alternate" title="Recent Commits to isetools:master" type="application/atom+xml">
  ...
  <div class="container clearfix">
    ...
    <div class="site-search repo-scope js-site-search" role="search">
      <form accept-charset="UTF-8" action="/emmental/isetools/search" class="js-site-search-form" data-global-search-url="/search" data-repo-search-url="/emmental/isetools/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <a href="/login?return_to=%2Femmental%2Fisetools"
    class="btn btn-sm btn-with-count tooltipped tooltipped-n"
    aria-label="You must be signed in to watch a repository" rel="nofollow">
    <span class="octicon octicon-eye"></span>
    Watch
  </a>
  <a class="social-count" href="/emmental/isetools/watchers">
    2
  </a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/emmental/isetools/stargazers">
      0
    </a>
    ...
    <li>
      ...
      <a href="/emmental/isetools/network" class="social-count">
        3
      </a>
    </li>
</ul>
        ...
        <h1 itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="entry-title public">
          ...
          <span class="author"><a href="/emmental" class="url fn" itemprop="url" rel="author"><span itemprop="title">emmental</span></a></span><!--
       --><span class="path-divider">/</span><!--
       --><strong><a href="/emmental/isetools" data-pjax="#js-repo-pjax-container">isetools</a></strong>
          ...
          <span class="page-context-loader">
            ...
            <span class="fork-flag">
              <span class="text">forked from <a href="/ubermichael/isetools">ubermichael/isetools</a></span>
            </span>
        </h1>
      </div><!-- /.container -->
    </div><!-- /.repohead -->
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders"
     ...
     data-issue-count-url="/emmental/isetools/issues/counts">
  <ul class="sunken-menu-group">
    <li class="tooltipped tooltipped-w" aria-label="Code">
      <a href="/emmental/isetools" aria-label="Code" class="selected js-selected-navigation-item sunken-menu-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /emmental/isetools">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pull requests">
      <a href="/emmental/isetools/pulls" aria-label="Pull requests" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g p" data-selected-links="repo_pulls /emmental/isetools/pulls">
  ...
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pulse">
      <a href="/emmental/isetools/pulse" aria-label="Pulse" class="js-selected-navigation-item sunken-menu-item" data-selected-links="pulse /emmental/isetools/pulse">
        <span class="octicon octicon-pulse"></span> <span class="full-word">Pulse</span>
        <img alt="" class="mini-loader" height="16" src="https://assets-cdn.github.com/assets/spinners/octocat-spinner-32-e513294efa576953719e4e2de888dd9cf929b7d62ed8d05f25e731d02452ab6c.gif" width="16" />
</a>    </li>

    <li class="tooltipped tooltipped-w" aria-label="Graphs">
      <a href="/emmental/isetools/graphs" aria-label="Graphs" class="js-selected-navigation-item sunken-menu-item" data-selected-links="repo_graphs repo_contributors /emmental/isetools/graphs">
...
<div class="js-clone-url clone-url open"
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini input-monospace js-url-field js-zeroclipboard-target"
           value="https://github.com/emmental/isetools.git" readonly="readonly">
...
<div class="js-clone-url clone-url "
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini input-monospace js-url-field js-zeroclipboard-target"
           value="https://github.com/emmental/isetools" readonly="readonly">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard btn btn-sm zeroclipboard-button tooltipped tooltipped-s" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
...
<div class="clone-options">You can clone with
  ...
  <a href="https://help.github.com/articles/which-remote-url-should-i-use" class="help tooltipped tooltipped-n" aria-label="Get help on which URL is right for you.">
    <span class="octicon octicon-question"></span>
                ...
                <a href="/emmental/isetools/archive/master.zip"
                   class="btn btn-sm sidebar-button"
                   aria-label="Download the contents of emmental/isetools as a zip file"
                   title="Download the contents of emmental/isetools as a zip file"
                   rel="nofollow">
...
<div class="select-menu js-menu-container js-select-menu left">
  ...
  <div class="btn-group right">
    <a href="/emmental/isetools/find/master"

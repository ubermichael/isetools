...
/**
 * DOMBuilderInterface creates a DOM from from either a File or a String. The class itself
...
public class DOMBuilder extends ISEParserBaseListener implements BuilderInterface<DOM> {
  ...
  /**
   * Constructs a BuilderInterface from a string. The resulting DOM source will be
   * "#STRING".
   * <p>
  ...
  /**
   * Constructs a BuilderInterface from a File. The resulting DOM source will return the

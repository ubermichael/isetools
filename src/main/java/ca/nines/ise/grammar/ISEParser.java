// Generated from src/main/java/ca/nines/ise/grammar/ISEParser.g4 by ANTLR 4.2.2
	...
	public final CharacterContext character() throws RecognitionException {
		...
		try {
			...
			case CHAR_CODEPOINT:
				enterOuterAlt(_localctx, 2);
				{
				setState(77); charCodePoint();
				}
				break;
			case CHAR_DIGRAPH:
				enterOuterAlt(_localctx, 3);
				{
				setState(78); charDigraph();
				}
				break;
			case CHAR_LIGATURE:
				enterOuterAlt(_localctx, 4);
				{
				setState(79); charLigature();
				}
				break;
			case CHAR_NESTED:
				enterOuterAlt(_localctx, 5);
				{
				setState(80); charNested();
				}
				break;
			case CHAR_SPACE:
				enterOuterAlt(_localctx, 6);
				{
				setState(81); charSpace();
				}
				break;
			case CHAR_TYPOGRAPHIC:
